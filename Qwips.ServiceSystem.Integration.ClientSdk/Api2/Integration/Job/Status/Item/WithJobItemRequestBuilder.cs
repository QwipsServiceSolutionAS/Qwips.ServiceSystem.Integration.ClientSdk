...
using System;
namespace Qwips.ServiceSystem.Integration.ClientSdk.Api2.Integration.Job.Status.Item
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Qwips.ServiceSystem.Integration.ClientSdk.Api2.Integration.Job.Status.Item.WithJobItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Qwips.ServiceSystem.Integration.ClientSdk.Models.ServiceProviderParentJobDataModel?> PostAsync(global::Qwips.ServiceSystem.Integration.ClientSdk.Models.JobStatusUpdateDto body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Qwips.ServiceSystem.Integration.ClientSdk.Models.ServiceProviderParentJobDataModel> PostAsync(global::Qwips.ServiceSystem.Integration.ClientSdk.Models.JobStatusUpdateDto body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Qwips.ServiceSystem.Integration.ClientSdk.Models.ServiceProviderParentJobDataModel>(requestInfo, global::Qwips.ServiceSystem.Integration.ClientSdk.Models.ServiceProviderParentJobDataModel.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Update job status
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Qwips.ServiceSystem.Integration.ClientSdk.Models.JobStatusUpdateDto body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Qwips.ServiceSystem.Integration.ClientSdk.Models.JobStatusUpdateDto body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Qwips.ServiceSystem.Integration.ClientSdk.Api2.Integration.Job.Status.Item.WithJobItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Qwips.ServiceSystem.Integration.ClientSdk.Api2.Integration.Job.Status.Item.WithJobItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
