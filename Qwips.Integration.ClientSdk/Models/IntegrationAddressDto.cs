...
namespace Qwips.Integration.ClientSdk.Models {
    public class IntegrationAddressDto : IParsable {
...
#nullable restore
        ...
        public static IntegrationAddressDto CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new IntegrationAddressDto();
        }
        /// <summary>
