...
namespace Qwips.Integration.ClientSdk.Models {
    public class IntegrationMachineDto : IParsable {
        /// <summary>The AssetType property</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public IntegrationAssetTypeDto? AssetType { get; set; }
#nullable restore
#else
        public IntegrationAssetTypeDto AssetType { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public IntegrationMachineModelDto? MachineModel { get; set; }
#nullable restore
#else
        public IntegrationMachineModelDto MachineModel { get; set; }
#endif
...
#nullable restore
        ...
        public static IntegrationMachineDto CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new IntegrationMachineDto();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                {"AssetType", n => { AssetType = n.GetObjectValue<IntegrationAssetTypeDto>(IntegrationAssetTypeDto.CreateFromDiscriminatorValue); } },
                ...
                {"MachineModel", n => { MachineModel = n.GetObjectValue<IntegrationMachineModelDto>(IntegrationMachineModelDto.CreateFromDiscriminatorValue); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<IntegrationAssetTypeDto>("AssetType", AssetType);
            ...
            writer.WriteObjectValue<IntegrationMachineModelDto>("MachineModel", MachineModel);
