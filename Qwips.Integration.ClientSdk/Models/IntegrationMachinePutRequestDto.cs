...
namespace Qwips.Integration.ClientSdk.Models {
    public class IntegrationMachinePutRequestDto : IParsable {
...
#nullable restore
        ...
        public static IntegrationMachinePutRequestDto CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new IntegrationMachinePutRequestDto();
        }
        /// <summary>
