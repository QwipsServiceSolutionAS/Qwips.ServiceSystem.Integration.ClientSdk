...
namespace Qwips.Integration.ClientSdk.Models {
    public class IntegrationStockEntryDto : IParsable {
...
#nullable restore
        ...
        public static IntegrationStockEntryDto CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new IntegrationStockEntryDto();
        }
        /// <summary>
