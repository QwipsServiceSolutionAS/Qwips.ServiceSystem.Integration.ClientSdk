...
namespace Qwips.Integration.ClientSdk.Models {
    public class IntegrationSupplierDto : IParsable {
...
#nullable restore
        ...
        public static IntegrationSupplierDto CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new IntegrationSupplierDto();
        }
        /// <summary>
