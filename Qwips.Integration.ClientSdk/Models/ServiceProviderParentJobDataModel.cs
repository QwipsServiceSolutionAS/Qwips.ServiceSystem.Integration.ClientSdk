...
namespace Qwips.Integration.ClientSdk.Models {
    public class ServiceProviderParentJobDataModel : IParsable {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<ServiceProviderChildJobDataModel>? InverseParent { get; set; }
#nullable restore
#else
        public List<ServiceProviderChildJobDataModel> InverseParent { get; set; }
#endif
...
#nullable restore
        ...
        public static ServiceProviderParentJobDataModel CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ServiceProviderParentJobDataModel();
        }
        /// <summary>
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"InverseParent", n => { InverseParent = n.GetCollectionOfObjectValues<ServiceProviderChildJobDataModel>(ServiceProviderChildJobDataModel.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<ServiceProviderChildJobDataModel>("InverseParent", InverseParent);
