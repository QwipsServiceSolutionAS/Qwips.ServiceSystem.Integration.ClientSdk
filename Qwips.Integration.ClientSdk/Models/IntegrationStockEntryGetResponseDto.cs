...
namespace Qwips.Integration.ClientSdk.Models {
    public class IntegrationStockEntryGetResponseDto : IParsable {
...
#nullable restore
        ...
        public static IntegrationStockEntryGetResponseDto CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new IntegrationStockEntryGetResponseDto();
        }
        /// <summary>
