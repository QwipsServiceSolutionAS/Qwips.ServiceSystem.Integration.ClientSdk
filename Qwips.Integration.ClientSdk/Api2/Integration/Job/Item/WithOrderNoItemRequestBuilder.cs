...
using System;
namespace Qwips.Integration.ClientSdk.Api2.Integration.Job.Item {
    /// <summary>
    /// Builds and executes requests for operations under \api2\Integration\Job\{orderNo}
    /// </summary>
    public class WithOrderNoItemRequestBuilder : BaseRequestBuilder {
        ...
        public WithOrderNoItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api2/Integration/Job/{orderNo}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WithOrderNoItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithOrderNoItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api2/Integration/Job/{orderNo}", rawUrl) {
        }
        /// <summary>
