...
using System;
namespace Qwips.Integration.ClientSdk.Api2.Integration.Job.InvoiceComment.Item {
    /// <summary>
...
#nullable enable
        public async Task<ServiceProviderParentJobDataModel?> PostAsync(JobInvoiceCommentUpdateDto body, Action<WithJobItemRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<ServiceProviderParentJobDataModel> PostAsync(JobInvoiceCommentUpdateDto body, Action<WithJobItemRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(JobInvoiceCommentUpdateDto body, Action<WithJobItemRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(JobInvoiceCommentUpdateDto body, Action<WithJobItemRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
