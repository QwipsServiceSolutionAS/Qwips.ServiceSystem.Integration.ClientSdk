...
using Qwips.Integration.ClientSdk.Api2.Integration.Job.AddPart;
using Qwips.Integration.ClientSdk.Api2.Integration.Job.InvoiceComment;
using Qwips.Integration.ClientSdk.Api2.Integration.Job.Item;
using Qwips.Integration.ClientSdk.Api2.Integration.Job.Resources;
using Qwips.Integration.ClientSdk.Api2.Integration.Job.ServiceManagerComment;
using Qwips.Integration.ClientSdk.Api2.Integration.Job.Status;
using System.Collections.Generic;
using System.IO;
using System.Linq;
using System.Threading.Tasks;
using System;
namespace Qwips.Integration.ClientSdk.Api2.Integration.Job {
    /// <summary>
    ...
    public class JobRequestBuilder : BaseRequestBuilder {
        ...
        /// <summary>Gets an item from the Qwips.Integration.ClientSdk.api2.Integration.Job.item collection</summary>
