...
using Qwips.Integration.ClientSdk.Api2.Integration.Customer.Item;
...
using System;
namespace Qwips.Integration.ClientSdk.Api2.Integration.Customer {
    /// <summary>
    ...
    public class CustomerRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Qwips.Integration.ClientSdk.api2.Integration.Customer.item collection</summary>
...
#nullable enable
        public async Task<List<IntegrationCustomerDto>?> GetAsync(Action<CustomerRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<List<IntegrationCustomerDto>> GetAsync(Action<CustomerRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            var requestInfo = ToGetRequestInformation(requestConfiguration);
            var collectionResult = await RequestAdapter.SendCollectionAsync<IntegrationCustomerDto>(requestInfo, IntegrationCustomerDto.CreateFromDiscriminatorValue, default, cancellationToken);
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<IntegrationCustomerDto?> PutAsync(IntegrationCustomerDto body, Action<CustomerRequestBuilderPutRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<IntegrationCustomerDto> PutAsync(IntegrationCustomerDto body, Action<CustomerRequestBuilderPutRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPutRequestInformation(IntegrationCustomerDto body, Action<CustomerRequestBuilderPutRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPutRequestInformation(IntegrationCustomerDto body, Action<CustomerRequestBuilderPutRequestConfiguration> requestConfiguration = default) {
#endif
