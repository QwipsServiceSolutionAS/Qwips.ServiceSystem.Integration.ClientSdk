...
using Qwips.ServiceSystem.Integration.ClientSdk.Api2.Integration.Article.Item;
...
using System;
namespace Qwips.ServiceSystem.Integration.ClientSdk.Api2.Integration.Article
{
    /// <summary>
    ...
    {
        /// <summary>Gets an item from the Qwips.ServiceSystem.Integration.ClientSdk.api2.Integration.Article.item collection</summary>
        ...
        public global::Qwips.ServiceSystem.Integration.ClientSdk.Api2.Integration.Article.Item.WithArticleNumberItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("articleNumber", position);
                return new global::Qwips.ServiceSystem.Integration.ClientSdk.Api2.Integration.Article.Item.WithArticleNumberItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Qwips.ServiceSystem.Integration.ClientSdk.Api2.Integration.Article.ArticleRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Qwips.ServiceSystem.Integration.ClientSdk.Models.PartDto?> PutAsync(global::Qwips.ServiceSystem.Integration.ClientSdk.Models.ArticleDataModel body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Qwips.ServiceSystem.Integration.ClientSdk.Models.PartDto> PutAsync(global::Qwips.ServiceSystem.Integration.ClientSdk.Models.ArticleDataModel body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPutRequestInformation(global::Qwips.ServiceSystem.Integration.ClientSdk.Models.ArticleDataModel body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPutRequestInformation(global::Qwips.ServiceSystem.Integration.ClientSdk.Models.ArticleDataModel body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Qwips.ServiceSystem.Integration.ClientSdk.Api2.Integration.Article.ArticleRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Qwips.ServiceSystem.Integration.ClientSdk.Api2.Integration.Article.ArticleRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Qwips.ServiceSystem.Integration.ClientSdk.Api2.Integration.Article.ArticleRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class ArticleRequestBuilderPutRequestConfiguration : RequestConfiguration<DefaultQueryParameters>
        {
        }
    }
}
