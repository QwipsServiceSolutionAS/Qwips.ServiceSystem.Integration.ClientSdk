...
using System;
namespace Qwips.Integration.ClientSdk.Api2.Integration.WarehouseLocation.Item {
    /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<IntegrationWarehouseLocationDto?> GetAsync(Action<WarehouseLocationItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<IntegrationWarehouseLocationDto> GetAsync(Action<WarehouseLocationItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
