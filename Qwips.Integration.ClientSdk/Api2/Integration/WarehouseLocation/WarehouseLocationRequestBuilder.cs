...
using Qwips.Integration.ClientSdk.Api2.Integration.WarehouseLocation.Item;
...
using System;
namespace Qwips.Integration.ClientSdk.Api2.Integration.WarehouseLocation {
    /// <summary>
    ...
    public class WarehouseLocationRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Qwips.Integration.ClientSdk.api2.Integration.WarehouseLocation.item collection</summary>
...
#nullable enable
        public async Task<List<IntegrationWarehouseLocationDto>?> GetAsync(Action<WarehouseLocationRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<List<IntegrationWarehouseLocationDto>> GetAsync(Action<WarehouseLocationRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            var requestInfo = ToGetRequestInformation(requestConfiguration);
            var collectionResult = await RequestAdapter.SendCollectionAsync<IntegrationWarehouseLocationDto>(requestInfo, IntegrationWarehouseLocationDto.CreateFromDiscriminatorValue, default, cancellationToken);
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<IntegrationWarehouseLocationDto?> PutAsync(IntegrationWarehouseLocationDto body, Action<WarehouseLocationRequestBuilderPutRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<IntegrationWarehouseLocationDto> PutAsync(IntegrationWarehouseLocationDto body, Action<WarehouseLocationRequestBuilderPutRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<IntegrationWarehouseLocationDto>(requestInfo, IntegrationWarehouseLocationDto.CreateFromDiscriminatorValue, default, cancellationToken);
        }
        /// <summary>
        /// Get warehouse location list. Has optional warehouse filter parameter.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPutRequestInformation(IntegrationWarehouseLocationDto body, Action<WarehouseLocationRequestBuilderPutRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPutRequestInformation(IntegrationWarehouseLocationDto body, Action<WarehouseLocationRequestBuilderPutRequestConfiguration> requestConfiguration = default) {
#endif
