...
using Qwips.Integration.ClientSdk.Api2.Integration.AssetType.Item;
...
using System;
namespace Qwips.Integration.ClientSdk.Api2.Integration.AssetType {
    /// <summary>
    ...
    public class AssetTypeRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Qwips.Integration.ClientSdk.api2.Integration.AssetType.item collection</summary>
...
#nullable enable
        public async Task<List<IntegrationAssetTypeDto>?> GetAsync(Action<AssetTypeRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<List<IntegrationAssetTypeDto>> GetAsync(Action<AssetTypeRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            var requestInfo = ToGetRequestInformation(requestConfiguration);
            var collectionResult = await RequestAdapter.SendCollectionAsync<IntegrationAssetTypeDto>(requestInfo, IntegrationAssetTypeDto.CreateFromDiscriminatorValue, default, cancellationToken);
