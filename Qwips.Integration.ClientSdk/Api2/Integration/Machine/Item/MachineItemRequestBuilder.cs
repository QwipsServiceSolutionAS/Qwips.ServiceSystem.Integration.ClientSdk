...
using System;
namespace Qwips.Integration.ClientSdk.Api2.Integration.Machine.Item {
    /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<IntegrationMachineDto?> GetAsync(Action<MachineItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<IntegrationMachineDto> GetAsync(Action<MachineItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            var requestInfo = ToGetRequestInformation(requestConfiguration);
            return await RequestAdapter.SendAsync<IntegrationMachineDto>(requestInfo, IntegrationMachineDto.CreateFromDiscriminatorValue, default, cancellationToken);
        }
        /// <summary>
        /// Deactivates a machine. This removes the machine from future workflows.
        /// </summary>
