...
using Qwips.Integration.ClientSdk.Api2.Integration.Machine.Item;
using Qwips.Integration.ClientSdk.Api2.Integration.Machine.SerialNumberSearch;
...
using System;
namespace Qwips.Integration.ClientSdk.Api2.Integration.Machine {
    /// <summary>
    ...
    public class MachineRequestBuilder : BaseRequestBuilder {
        ...
        public SerialNumberSearchRequestBuilder SerialNumberSearch { get =>
            new SerialNumberSearchRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Gets an item from the Qwips.Integration.ClientSdk.api2.Integration.Machine.item collection</summary>
...
#nullable enable
        public async Task<List<IntegrationMachineDto>?> GetAsync(Action<MachineRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<List<IntegrationMachineDto>> GetAsync(Action<MachineRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<IntegrationMachinePutRequestDto?> PutAsync(IntegrationMachinePutRequestDto body, Action<MachineRequestBuilderPutRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<IntegrationMachinePutRequestDto> PutAsync(IntegrationMachinePutRequestDto body, Action<MachineRequestBuilderPutRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<IntegrationMachinePutRequestDto>(requestInfo, IntegrationMachinePutRequestDto.CreateFromDiscriminatorValue, default, cancellationToken);
        }
        /// <summary>
        /// Get machine list, with optional search parameter and filters.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPutRequestInformation(IntegrationMachinePutRequestDto body, Action<MachineRequestBuilderPutRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPutRequestInformation(IntegrationMachinePutRequestDto body, Action<MachineRequestBuilderPutRequestConfiguration> requestConfiguration = default) {
#endif
