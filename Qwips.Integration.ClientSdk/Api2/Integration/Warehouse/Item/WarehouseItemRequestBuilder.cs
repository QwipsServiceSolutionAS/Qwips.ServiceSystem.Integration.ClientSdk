...
using System;
namespace Qwips.Integration.ClientSdk.Api2.Integration.Warehouse.Item {
    /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<IntegrationWarehouseDto?> GetAsync(Action<WarehouseItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<IntegrationWarehouseDto> GetAsync(Action<WarehouseItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
