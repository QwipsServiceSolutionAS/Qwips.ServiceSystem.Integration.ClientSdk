...
using Qwips.Integration.ClientSdk.Api2.Integration.Supplier.Item;
...
using System;
namespace Qwips.Integration.ClientSdk.Api2.Integration.Supplier {
    /// <summary>
    ...
    public class SupplierRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the Qwips.Integration.ClientSdk.api2.Integration.Supplier.item collection</summary>
...
#nullable enable
        public async Task<List<IntegrationSupplierDto>?> GetAsync(Action<SupplierRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<List<IntegrationSupplierDto>> GetAsync(Action<SupplierRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            var requestInfo = ToGetRequestInformation(requestConfiguration);
            var collectionResult = await RequestAdapter.SendCollectionAsync<IntegrationSupplierDto>(requestInfo, IntegrationSupplierDto.CreateFromDiscriminatorValue, default, cancellationToken);
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<IntegrationSupplierDto?> PutAsync(IntegrationSupplierDto body, Action<SupplierRequestBuilderPutRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<IntegrationSupplierDto> PutAsync(IntegrationSupplierDto body, Action<SupplierRequestBuilderPutRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPutRequestInformation(IntegrationSupplierDto body, Action<SupplierRequestBuilderPutRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPutRequestInformation(IntegrationSupplierDto body, Action<SupplierRequestBuilderPutRequestConfiguration> requestConfiguration = default) {
#endif
