...
using System;
namespace Qwips.Integration.ClientSdk.Api2.Integration.Stock.Item {
    /// <summary>
...
#nullable enable
        public async Task<List<IntegrationStockEntryGetResponseDto>?> DeleteAsync(Action<StockItemRequestBuilderDeleteRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<List<IntegrationStockEntryGetResponseDto>> DeleteAsync(Action<StockItemRequestBuilderDeleteRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<IntegrationStockEntryGetResponseDto?> GetAsync(Action<StockItemRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<IntegrationStockEntryGetResponseDto> GetAsync(Action<StockItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            var requestInfo = ToGetRequestInformation(requestConfiguration);
            return await RequestAdapter.SendAsync<IntegrationStockEntryGetResponseDto>(requestInfo, IntegrationStockEntryGetResponseDto.CreateFromDiscriminatorValue, default, cancellationToken);
        }
        /// <summary>
        /// Delete a stock entry.
        /// </summary>
